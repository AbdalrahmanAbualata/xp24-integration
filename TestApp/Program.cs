    ...
    internal class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                await client.ConnectAsync("10.9.2.196", 5556, appStopped);
                ...
                const string sfjFilePath = @"abdtest.sjf";
                ...
                // load a new document
                await machineApi.LoadDocumentAsync("my_card", await System.IO.File.ReadAllBytesAsync(sfjFilePath, appStopped));
                ...
                await machineApi.UpdateDocumentAsync(new Entity[]
                {
                    ...
                    new UpdateTextEntity("LayoutName", "Pablo Julian"),
